...
The process to computationally parse and analyze the data gathered was accomplished using a systematic workflow. The metadata set was first downloaded from the NCBI database and 
